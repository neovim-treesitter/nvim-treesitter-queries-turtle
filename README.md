# nvim-treesitter-queries-turtle

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-turtle/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-turtle/actions/workflows/validate.yml)

Neovim tree-sitter queries for **turtle**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-turtle",
...
- [ ] Changes are scoped to `turtle` — do not include files for other languages
